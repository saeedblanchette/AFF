...
const HomeSlider = () => {
  const pagination = {
    clickable: true,
    bulletClass:
      "swiper-pagination-bullet bg-gray-500 m-2 rounded-full p-0 bg-gray-100 text-gray-100",
    bulletActiveClass:
      "bg-gray-500 m-2 rounded-full p-0 bg-yellow-100 swiper-pagination-bullet-active",
        ...
        {Slides.map((item, i) => (
          <SwiperSlide key={i}>
            ...
            >
              ...
              />
              <motion.div
                className="absolute bottom-1/4  left-[10%] z-10  h-96 bg-slate-50  w-1/2 p-4"
                variants={animation}
                initial="offscreen"
              ...
              >
                <motion.h1
                  ...
                  whileInView="onscreen"
                  viewport={{ once: false, amount: 0.8 }}
                  className="text-natural-50 font-bold  text-gray-500 text-6xl"
                >
                  Vision
                </motion.h1>
              </motion.div>
