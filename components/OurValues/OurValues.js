...
const valuesList = [
  {
    ...
    icon: (
      <SustainableSvg className="fill-yellow-500 h-40 w-40 m-auto " />
    ),
    description:
...

  {
    ...
    image: "/images/Capture d’écran 2022-08-17 à 17.19.44.png",
    icon: (
      <SynergySvg className="fill-yellow-500 h-40 w-40 m-auto " />
    ),
    description:
      "Lorem ipsum dolor sit amet consectetur adipiscing elito Sllamcorper est massa pretium   egetas Sagittis nulla cursus Lorem ipsum dolor sit amet",
  },
  {
    ...
    icon: (
      <BussinessSvg className="fill-yellow-500 h-40 w-40 m-auto " />
    ),
    description:
      "Lorem ipsum dolor sit amet consectetur adipiscing elito Sllamcorper est massa pretium   egetas Sagittis nulla cursus Lorem ipsum dolor sit amet",
  },
  {
    ...
    image: "/images/Capture d’écran 2022-08-17 à 18.03.49.png",
    icon: (
      <InnovationSvg className="fill-yellow-500 h-40 w-40 m-auto " />
    ),
    description:
      "Lorem ipsum dolor sit amet consectetur adipiscing elito Sllamcorper est massa pretium   egetas Sagittis nulla cursus Lorem ipsum dolor sit amet",
  },
      ...
      <div className="flex  justify-between">
        {valuesList.map((item, i) => (
          ...
          >
            ...
            {item.icon}
            <div className=" py-2">
              <h3 className="font-bold text-xl  py-3  text-center text-gray-700">
                {item.title}
              </h3>
