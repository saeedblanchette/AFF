...
const Navigation = () => {
  return (
    <nav className="flex  container px-16 mx-auto  mx-auto">
      <div className="m-auto p-4">
        <img src="/logoSite-2.gif" width="200" alt="ds" className="m-auto" />
      </div>
      ...
      <div className="flex  text-md  justify-center items-center m-auto ">
        ...
        <span className="m-1 p-1 font-bold underline decoration-yellow-600">
          ENG
        </span>
        <span className="m-1 p-1 font-bold">FR</span>
      </div>
